...
class ABCDE(BaseModel):
	"""Representa a estrutura ABCDE legada de uma entrada do diário."""
	model_config = {"extra": "ignore"}
...
class AnalysisResult(BaseModel):
	...
	gatilhos: list[ABCDETrigger] = Field(default_factory=list)  # ADR-018/019/020
	abcde: ABCDE | None = None  # compatibilidade temporária
	resumo: str = ""
